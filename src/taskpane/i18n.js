var i18n = {
  es: {
    ...
    SETTING_APP_LANG: "Idioma de la aplicación",
    SETTING_APP_LANG_LABEL: "Establecer el idioma a:",
    SETTING_APP_LANG_HELP: "Debes recargar la app para ver los cambios.",
    SETTING_TIT_DIS: "Disposición preferida",
    SETTING_TIT_VERS: "Versión",
    SETTING_VERS_VIS: "Visible",
    SETTING_VERS_WRAP: "Envoltorio",
    SETTING_WRAPPER_NONE: "Ninguno",
    SETTING_WRAPPER_PAREN: "Paréntesis",
    SETTING_WRAPPER_BRACK: "Corchetes",
    SETTING_VERS_POS: "Posicionamiento",
    SETTING_VERS_POS_UP: "Superior",
    SETTING_VERS_POS_DOWN: "Inferior",
    SETTING_TIT_BC: "Libro y capítulo",
    SETTING_BC_PRES: "Presentación",
    SETTING_BC_PRES_BV: "Idioma versión de la Biblia",
    SETTING_BC_PRES_BVA: "Idioma versión de la Biblia (Abrev)",
    SETTING_BC_PRES_FULL: "Muestra referencia completa",
    SETTING_BC_WRAP: "Envoltorio",
    SETTING_BC_POS: "Posicionamiento",
    SETTING_BC_POS_UP: "Superior",
    SETTING_BC_POS_DOWN: "Inferior",
    SETTING_BC_POS_IN_DOWN: "Inferior en la línea",
    SETTING_VERSE_VIS: "Versículo visible",
    "Juan 3, 16": "Juan 3, 16",
    "Creación": "Creación",
    "Consultar": "Consultar",
  ...
  en: {
    ...
    SETTING_APP_LANG: "App Language",
    SETTING_APP_LANG_LABEL: "Set language to:",
    SETTING_APP_LANG_HELP: "You must reload the app to see the changes.",
    SETTING_TIT_DIS: "Preferred layout",
     SETTING_TIT_VERS: "Version",
     SETTING_VERS_VIS: "Visible",
     SETTING_VERS_WRAP: "Wrapper",
     SETTING_WRAPPER_NONE: "None",
     SETTING_WRAPPER_PAREN: "Parentheses",
     SETTING_WRAPPER_BRACK: "Brackets",
     SETTING_VERS_POS: "Positioning",
     SETTING_VERS_POS_UP: "Top",
     SETTING_VERS_POS_DOWN: "Down",
     SETTING_TIT_BC: "Book and Chapter",
     SETTING_BC_PRES: "Presentation",
     SETTING_BC_PRES_BV: "Language Bible version",
     SETTING_BC_PRES_BVA: "Language Bible version (Abrev)",
     SETTING_BC_PRES_FULL: "Show full reference",
     SETTING_BC_WRAP: "Wrapper",
     SETTING_BC_POS: "Positioning",
     SETTING_BC_POS_UP: "Top",
     SETTING_BC_POS_DOWN: "Down",
     SETTING_BC_POS_IN_DOWN: "In line - down",
     SETTING_VERSE_VIS: "Visible Verse", 
    "Juan 3, 16": "Jhon 3, 16",
    "Creación": "Creation",
    "Consultar": "Search",
